...
public class Game extends Canvas implements Runnable {
    ...
    public Game(){
        ...
        new Window(WIDTH,HEIGHT, "GameDeveloping!", this);
...
//           handler.addObject(new Player(WIDTH/2+64, HEIGHT/2-32, ID.Player2, handler));
    ...
    public void run(){ //runtime "heartbeat" code-thing
        this.requestFocus();
    ...
    private void render(){
        ...
        if (gameState == STATE.Game){
            ...
            g.drawString("FPS: " + dispFPS, 550, 30);
        }
        else if (gameState  == STATE.Menu || gameState == STATE.Help || gameState  == STATE.End || gameState == STATE.Item){
            menu.render(g);
        }
